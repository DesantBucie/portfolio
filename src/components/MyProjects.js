    ...
    return (
        <div className="my-projects" id="my-projects">
            ...
            direction="row-reverse">
                <Grid container item sm={12} md={6}>
                <p>
                    <a href="https://github.com/DesantBucie/paleofetch-bsd">Paleofetch-BSD</a> is a fork of a copy of neofetch written in C. Currently works only on mac, I'll try to bring it on the BSDs and Solaris family. It is on macOS even <b>20 times faster</b> than neofetch. Most of code is new.
                </p>
                </Grid>
                <Grid container item sm={12} md={6}>
            ...
            direction="row-reverse">
                <Grid container item sm={12} md={6}>
                <p>
                    <a href="https://github.com/DesantBucie/aquila">Aquila</a> is old learning project, that is quite abandoned that I'm sure has many mistakes, and outdates, but it's example of me working with data from api.
                </p>
                </Grid>
                <Grid container item sm={12} md={6}>
